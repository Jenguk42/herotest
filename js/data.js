const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 남들은 알아차리지 못하지만 나는 느낄 수 있다. (예시: 전류의 흐름이 남들보다 세밀하게 느껴짐)', score: 1 },
      { answer: 'b. 미약하더라도 분명한 변화를 이끌어낼 수 있다. (예시: 약한 정전기를 일으킬 수 있음)', score: 3 },
      { answer: 'c. 주위의 눈길을 끌 정도로 강한 편이다. (예시: 꺼진 가로등을 잠깐 켜둘 수 있음)', score: 5 },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 개인에게 사소한 영향을 끼칠 수 있다. (예시: 상대방이 당근을 좋아하게 만들 수 있음)', score: 2 },
      { answer: 'c. 사회에 큰 영향을 끼칠 수 있다. (예시: 5분 뒤의 교통 정보를 예측할 수 있음)', score: 5 },
      { answer: 'd. 개인에게 큰 영향을 끼칠 수 있다. (예시: 상대방을 명확히 이해할 수 있음)', score: 6 },
      { answer: 'e. 정치, 경제, 군사적 방면에서 사회에 큰 영향을 끼칠 수 있다. (예시: 상대방을 세뇌할 수 있음)', score: 8 },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'e. 제약이 무척 크나, 능력의 강도 및 사회적 영향력을 고려한다면 충분히 용인할 수 있다.', score: 5 },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'e. 사용 범위가 무척 작으나, 능력의 강도 및 사회적 영향력을 고려한다면 충분히 용인할 수 있다.', score: 5 }
    ]
  },
  {
