const qnaList = [
  {
    q: '1. 능력의 강도는?',
    a: [
      { answer: 'a. 이성 사이에 친구가 어딨어? 절대 없어', score: 0 },
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', score: 2 },
      { answer: 'c. 난 잘 모르겠어..', score: 4 },
      { answer: 'd. 난 잘 모르겠어..', score: 6 },
      { answer: 'e. 난 잘 모르겠어..', score: 8 },
      { answer: 'f. 난 잘 모르겠어..', score: 10 }
    ]
  },
  {
    q: '2. 이성 사이에 진정한 친구는 있다, 없다?',
    a: [
      { answer: 'a. 이성 사이에 친구가 어딨어? 절대 없어', score: 0 },
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', score: 2 },
      { answer: 'c. 난 잘 모르겠어..', score: 4 },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 이성 사이에 친구가 어딨어? 절대 없어', score: 0 },
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', score: 1 },
      { answer: 'c. 난 잘 모르겠어..', score: 2 },
      { answer: 'd. 난 잘 모르겠어..', score: 3 },
      { answer: 'e. 난 잘 모르겠어..', score: 4 },
      { answer: 'f. 난 잘 모르겠어..', score: 5 }
    ]
  },
  {
    q: '4. 이성 사이에 진정한 친구는 있다, 없다?',
    a: [
      { answer: 'a. 이성 사이에 친구가 어딨어? 절대 없어', score: 0 },
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', score: 1 },
      { answer: 'c. 난 잘 모르겠어..', score: 2 },
